...
### 节点 `delete_tool` · delete resource

节点类型：`TOOL`；风险项：1；最高等级：`HIGH`

#### [HIGH] action_authorization · delete resource：高影响动作授权控制不足
...
- 合并证据实例：4
- 规则映射：TOOL-002, TOOL-008, TOOL-015, FLOW-003
