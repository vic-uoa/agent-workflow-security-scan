...
- 节点/边：4 / 3
- Finding 数：8
- 严重等级：HIGH=6、MEDIUM=2
- 证据状态：CONFIRMED=5、PROBABLE=2、COVERAGE_GAP=1
- 发布门禁：`FAIL`
...
- 路径：`start → llm → tool`
- 状态：`CONFIRMED`
- 动态用例：TC-8f84f3d9b496, TC-32c4f7cf49fb
...
- 动态用例：TC-82600a16c1b4, TC-1fcf8b4bb548
