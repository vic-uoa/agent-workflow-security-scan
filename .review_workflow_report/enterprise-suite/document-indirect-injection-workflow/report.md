...
- 节点/边：5 / 4
- Finding 数：17
- 严重等级：CRITICAL=2、HIGH=12、MEDIUM=3
- 证据状态：CONFIRMED=11、PROBABLE=4、COVERAGE_GAP=2
- 发布门禁：`FAIL`
...
- 动态用例：TC-184aba591794, TC-ce28491db959, TC-373d7df36657, TC-3e66094f03cb, TC-1caeae627294
...
- 路径：`extract → llm`
- 状态：`CONFIRMED, PROBABLE`
- 动态用例：TC-2dc7904932bf, TC-265b85758dfd

### HIGH · LLM-005, LLM-006, LLM-008, OUT-006, TOOL-002
