...
### [HIGH] TOOL-008 · send-email：高影响动作授权控制不足

责任节点“send-email”在“高影响动作授权控制不足”方面存在 3 个规则或路径实例；主项按最强静态证据定级，具体影响见实例明细。

- 状态：`CONFIRMED`；置信度：1.00
- 责任节点：`tool`；控制域：`action_authorization`
...
- 根因指纹：`RISK-808c4fa56b05`
- 关联规则（不重复计数）：FLOW-003, LLM-008
