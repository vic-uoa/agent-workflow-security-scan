...
- 建议测试用例（未执行）：TC-44a551d3ab04, TC-039fd8e43876, TC-a7e36782e2c4, TC-5cd80b69dc20, TC-71d25d8b3831, TC-bd5cb3b31583, TC-35d5b6f01ae2, TC-e77b7138cfb8, TC-4b385db82b3e, TC-ac2743a6eaad
...
- 建议测试用例（未执行）：TC-0f3e3a19d35c, TC-c8a319682f87, TC-2d1cfadb15ea, TC-f558fb781e8e, TC-2bf0f6428d90, TC-bd5cb3b31583, TC-35d5b6f01ae2, TC-e77b7138cfb8, TC-4b385db82b3e, TC-ac2743a6eaad
...
- 路径：`web → llm1`
- 状态：`CONFIRMED`
- 建议测试用例（未执行）：TC-ac2743a6eaad, TC-bd5cb3b31583, TC-35d5b6f01ae2, TC-e77b7138cfb8, TC-4b385db82b3e
...
- 状态：`PROBABLE`
- 建议测试用例（未执行）：TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-0eb9329e67f3
...
#### [HIGH] agent_governance · 执行 Agent：Agent 目标与停止边界不足
...
责任节点“执行 Agent”在“外部内容信任边界不足”方面存在 5 个规则或路径实例；主项按最强静态证据定级，具体影响见实例明细。

- 状态：`CONFIRMED`；置信度：1.00
- 当前证据等级：`HIGH`；最大潜在等级：`HIGH`
- 代表路径：`web → llm1 → llm2`；路径变体：5
- 合并证据实例：5
- 规则映射：TOOL-012, FLOW-005, KB-005, LLM-003
- DSL 位置：`/workflow/graph/nodes/2`, `/workflow/graph/nodes/3`, `/workflow/graph/nodes/5`, `/workflow/graph/nodes/4`, `/workflow/graph/nodes/1`, `/workflow/graph/nodes/6`, `/workflow/graph/nodes/7`, `/workflow/graph/nodes/8`
- 证据：`FACT-5e4c852144bd`, `FACT-caa1117d6700`, `FACT-933bd4ac2531`, `FACT-db828845b05b`, `FACT-03cb64251cf0`, `FACT-c04a7004147f`, `FACT-52dea32ea1ca`, `FACT-324968fc9a7c`, `FACT-854f029a08ca`, `FACT-37b8f2b4a341`, `FACT-4fdf33318628`
