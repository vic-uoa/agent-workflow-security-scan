...
- 用户种子样例：1
- 派生用例：25
- 类型分布：positive=1、boundary=1、metamorphic=1、negative=22
- 血缘校验：`通过`
...
- 建议测试用例（未执行）：TC-1e473bba6fc4, TC-7273d0fc5cb4, TC-71a03bd0c198, TC-0b3f6308962f, TC-abfa9f21e1eb
...
- 路径：`llm → answer`
- 状态：`CONFIRMED, PROBABLE`
- 建议测试用例（未执行）：TC-7273d0fc5cb4, TC-1e473bba6fc4, TC-0b3f6308962f, TC-71a03bd0c198
...
- 路径：`kb → http`
- 状态：`CONFIRMED`
- 建议测试用例（未执行）：TC-c87f83394e28, TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-4c1b0e40ea3b
...
- 路径：`start`
- 状态：`PROBABLE`
- 建议测试用例（未执行）：TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-4bd7bcbfe2e0
...
- 路径：`start → llm → http`
- 状态：`CONFIRMED`
- 建议测试用例（未执行）：TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-4c1b0e40ea3b, TC-c87f83394e28
...
- 路径：`start → llm`
- 状态：`PROBABLE`
- 建议测试用例（未执行）：TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-55d9b91e1cac
...
- 路径：`kb → start → llm`
- 状态：`PROBABLE`
- 建议测试用例（未执行）：TC-1be424fc394b, TC-d7984eb856cb, TC-83c5e2475f5c, TC-f10de959d667
